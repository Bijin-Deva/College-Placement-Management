...
export default function JobManager() {
  ...
  // 2. Created the ref variable right under your state definitions
  ...
  const handleEdit = (job) => {
    ...
    // 3. Changed window.scrollTo to point directly to your form container ref
    setTimeout(() => {
  ...
  return (
    <div style={{ padding: "0px", position: "relative" }}>
      ...
      {isOpen && (
        /* 4. Attached the ref={formRef} right here on your form wrapper div */
        <div ref={formRef} style={{border:"1px solid black", padding: "20px", marginTop: "20px", borderRadius: "5px"}}>
          <div>
            <h3>{editingJobId ? "Edit Job Details" : "Create New Job"}</h3>
            <hr />
            <form onSubmit={handleSubmit}>
