...
function RegistrationPage(){
    ...
    return (
    /* New Fullscreen Background Wrapper */
    <div 
      className="w-100 min-vh-100 d-flex align-items-center justify-content-center m-0"
      style={{
        ...
        padding: "40px 0" // Adds breathing room at top and bottom when scrolling
      }}
    >
      {/* Your original card with bg-white added so it doesn't become see-through */}
      <div 
